...
export const GeneralUnconnected = ({ samlSettings, settingsUpdated }: Props): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      >
        <Input {...register('name')} id="displayName" width={60} placeholder="SAML" />
      </Field>
      <Field
        label="Entity ID"
        description="The entity ID is a globally unique identifier for the service provider. It is used to identify the service provider to the identity provider. Defaults to the URL of the Grafana instance."
      >
